...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/dash/assets/css/default-css.css')}}"> <link rel="stylesheet" type="text/css" href="{{ asset('assets/DataTables/datatables.min.css')}}"/>
